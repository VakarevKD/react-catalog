...
export const FavoriteButton = ({ favorite }: FavoriteProps) => {
	const favoriteClass = (favorite) ? classNames(style.favorite, style.favorite_active) : classNames(style.favorite);
